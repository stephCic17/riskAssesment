...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $rootScope) {
  ...
  $rootScope.updateBar = function() {
    document.getElementById("progression").setAttribute('style','width :' + ($rootScope.currentStep * 100 / $scope.totalStep) + '%');
  }
...
.run(function($ionicPlatform) {
  ...
  $ionicPlatform.ready(function() {
    ...
    //     StatusBar.backgroundColorByHexString("#529599");
    // }
  });
})
